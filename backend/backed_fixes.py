...
def filter_kql_output_by_user(output_text: str, username: str, step_name: str) -> str:
    ...
    if "reputation" in step_name_lower or "virustotal" in step_name_lower or len(output_text) < 100:
        return output_text
    ...
    user_rows = [line for line in lines[data_start_index:] if username.lower() in line.lower()]
