...
# ============================================================================
    ...
    with st.spinner("Processing..."):
        try:
            ...
            status_text.text(
                "🛠️ Enhancing explanations + validating KQL (parallel processing)..."
            )
            ...
            # [OK] SHOW VALIDATION RESULTS IN UI
            st.success(
                ...
                for i, (original, enhanced) in enumerate(
                    ...
                    with st.expander(
                        ...
                        if len(enhanced.get("explanation", "")) > len(
                            ...
                            changes.append("✏️ Explanation enhanced")
                        if not enhanced.get("kql_query") and original.get("kql_query"):
                            changes.append("⚡ KQL removed (validation failed)")
            ...
            with tab4:
                st.markdown("### ✏️ All Enhanced Steps")
