...
st.markdown(
    "Automate security alert triaging with AI-powered analysis and step-by-step guidance."
)
...
# ============================================================================
# STEP 3: AI-POWERED TRIAGING WALKTHROUGH (ENHANCED WITH PROGRESSIVE PREDICTIONS)
# ============================================================================
        ...
        with st.spinner("This may take 30-60 seconds..."):
            try:
                analysis_status.info(
                    "🧠 AI is learning from ALL historical data and templates..."
                )
    ...
    if current_step_index < total_steps:
        ...
        # NEW: Progressive Prediction Display
        ...
        if not requires_input:
            st.markdown(
                '<div class="auto-proceed">✅ This step does not require manual input. Review and proceed.</div>',
                unsafe_allow_html=True,
            )
        ...
        with col3:
            if st.button(
                "⭐ Skip to End", help="Skip remaining steps and go to summary"
            ):
...
# ============================================================================
# STEP 4: TRIAGING COMPLETE (ENHANCED WITH CSV EXPORT)
# ============================================================================
    ...
    if st.session_state.predictions:
        ...
        with col2:
            ...
            st.metric(
                "Confidence Level",
                confidence,
                help="AI's confidence in this prediction",
            )
    ...
    with col1:
        st.download_button(
            ...
            mime="text/plain",
            use_container_width=True,
            help="Download the completed investigation report",
        )
    ...
    with col2:
        st.download_button(
            ...
            mime="text/csv",
            use_container_width=True,
            help="Download structured CSV template for manual investigations with expected outputs",
        )
    ...
    # Preview tabs
    with st.expander("📄 Preview Reports"):
        tab1, tab2 = st.tabs(["Completed Report", "CSV Template Preview"])
